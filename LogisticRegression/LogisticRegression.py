...
class LogisticRegressionSGD(object):
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_iter):
            ...
            print("Epoch count", i , ":", "Loss Function", self.cost_[i])
...
lrgd = LogisticRegressionGD(eta=0.00001, n_iter=100, random_state=1)
...
print("Time for plotting",end - start)
y_test_pred = lrgd.predict(X_test)
for i in range(5):
  print("test(" + str(i) + ")",y_test[i])
  print("predicted(" + str(i) + ")",y_test_pred[i])
